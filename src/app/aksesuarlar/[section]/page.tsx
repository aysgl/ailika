...
function mapSection(section: string): {label: string; category?: string} {
    ...
    if (s === 'sablonlar') return {label: 'Şablonlar', category: 'sablonlar'}
    if (s === 'torpuler') return {label: 'Törpüler', category: 'torpuler'}
    if (s === 'fircalar') return {label: 'Fırçalar', category: 'fircalar'}
    if (s === 'freze-uclari')
        return {label: 'Freze Uçları', category: 'freze-uclari'}
